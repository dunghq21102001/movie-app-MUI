  ...
  return (
    <Box display='flex' justifyContent='space-around' alignItems='center' width='100%' >
      <Box sx={{
        ...
        flexDirection: 'column', padding: '20px 0 60px 0', position: 'relative', minHeight: '300px', width: { xs: '94%', sm: '60%' }, justifyContent: 'space-around'
      }}>
        ...
        <Button sx={{ width: { xs: '60%', sm: '20%' }, position: 'absolute', right: '15px', bottom: '10px'}} onClick={handleSubmit} type='submit' variant='contained'>Send Message</Button>
      </Box>
